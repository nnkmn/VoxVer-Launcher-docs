...
MCLa has a built-in crash monitoring system that automatically captures logs and analyzes them when the game exits unexpectedly.
...
1. Export the crash report from MCLa
2. Go to [GitHub Issues](https://github.com/nnkmn/MCLA/issues) to submit the issue
